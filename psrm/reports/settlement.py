...
acl = ru.annotate_acl(ps.udtraeksdata, claimant=DR_ID)
...
udl_ir = ru.sum_NYMF(udl, HF=False).rename(columns={'AMOUNT': 'UDL_INTEREST'})
...
afr_ir = ru.sum_NYMF(afr, HF=False).rename(columns={'AMOUNT': 'AFR_INTEREST'})
